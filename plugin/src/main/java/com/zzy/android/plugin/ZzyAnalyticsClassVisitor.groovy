...
class ZzyAnalyticsClassVisitor extends ClassVisitor {
    ...
    ZzyAnalyticsClassVisitor(final ClassVisitor classVisitor, ClassNameAnalytics classNameAnalytics, ZzyAnalyticsTransformHelper transformHelper) {
        super(ZzyAnalyticsUtil.ASM_VERSION, classVisitor)
