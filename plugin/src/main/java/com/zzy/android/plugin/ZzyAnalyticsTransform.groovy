...
class ZzyAnalyticsTransform extends Transform {
    private ZzyAnalyticsTransformHelper transformHelper
    ...
    ZzyAnalyticsTransform(ZzyAnalyticsTransformHelper transformHelper, boolean isProjectLibrary) {
    ...
    private void checkRNState() {
        try {
            ...
            try {
                ...
                transformHelper.rnState = ZzyAnalyticsTransformHelper.RN_STATE.HAS_VERSION
            } catch (Exception e) {
                transformHelper.rnState = ZzyAnalyticsTransformHelper.RN_STATE.NO_VERSION
            }
        } catch (Exception e) {
            transformHelper.rnState = ZzyAnalyticsTransformHelper.RN_STATE.NOT_FOUND
        }
    }
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (entryName.endsWith(".DSA") || entryName.endsWith(".SF")) {
                ...
                try {
                    ...
                    sourceClassBytes = ZzyAnalyticsUtil.toByteArrayAndAutoCloseStream(inputStream)
                } catch (Exception e) {
    ...
    private byte[] modifyClass(byte[] srcClass, ClassNameAnalytics classNameAnalytics) {
        try {
            ...
            ClassVisitor classVisitor = new ZzyAnalyticsClassVisitor(classWriter, classNameAnalytics, transformHelper)
    ...
    private File modifyClassFile(File dir, File classFile, File tempDir) {
        ...
        try {
            ...
            ClassNameAnalytics classNameAnalytics = transformHelper.analytics(className)
            if (classNameAnalytics.isShouldModify) {
                byte[] sourceClassBytes = ZzyAnalyticsUtil.toByteArrayAndAutoCloseStream(new FileInputStream(classFile))
